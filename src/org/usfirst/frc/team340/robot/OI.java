...
import org.usfirst.frc.team340.robot.commands.FollowPath;
...
//		driverLB.whenPressed(new ManualClimberGoAtEngagementSpeed());
//		driverLB.whenReleased(new ManualClimberGoStopped());
